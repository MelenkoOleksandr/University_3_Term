...
//        for (int size : SIZES) {
        int size = 10;
            ...
            printMatrix(simpleMultiplying(a, b));
            printMatrix(TapeMultiplying.multiply(a, b, 2));
            printMatrix(FoxMultiplying.multiply(a, b, 2));
            printMatrix(CannonMultiplying.multiply(a, b, 2));
