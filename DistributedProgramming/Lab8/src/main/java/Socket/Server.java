...
public class Server {
    ...
    public static void addNewCategory(String[] queryParts) {
        try {
            ...
            grocery.addProductCategory(new ProductCategory(categoryId, categoryName));
   ...
   public static void searchProductByName(String[] queryParts) {
    ...
    public static void getAllProductsInCategory(String[] queryParts) {
        try {
            ...
            if (products == null) {
                ...
                sendResponse(ServerResponse.SUCCESS.getStatus(), "Products found");
    ...
    public static void getAllCategories() {
        try {
            ...
            ProductCategory[] categories = grocery.getAllProductCategories();
            if (categories == null) {
                sendResponse(ServerResponse.SUCCESS.getStatus(), "No categories found");
            } else {
                sendResponse(ServerResponse.SUCCESS.getStatus(), "Categories found");
