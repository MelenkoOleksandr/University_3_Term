...
public class Client2 {
    ...
    public static void showMenu() {
        ...
        System.out.println("7. Search for a  by name");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "3" -> {
                    ...
                    grocery.addProductToCategory(newProductCategoryId, newProductName, newProductPrice, newProductQuantity);
                }
                case "4" -> {
                ...
                case "5" -> {
                    ...
                    int newProductQuantity = Integer.parseInt(scanner.nextLine());
                    grocery.editProduct(productId, categoryId, newProductName, newProductPrice, newProductQuantity);
                }
                case "6" -> {
                    System.out.println("Enter category ID: ");
                    int categoryId = Integer.parseInt(scanner.nextLine());
                    System.out.println("Total amount of products in category " + categoryId + " is " + grocery.countProductsInCategory(categoryId));
                }
                case "7" -> {
                    System.out.println("Enter product name: ");
                ...
                case "8" -> {
                    System.out.println("Enter category ID: ");
                    int categoryId = Integer.parseInt(scanner.nextLine());
                    for (Product product : grocery.getAllProductsInCategory(categoryId)) {
